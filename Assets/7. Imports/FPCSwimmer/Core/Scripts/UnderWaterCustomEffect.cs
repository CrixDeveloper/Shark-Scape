...
// This file is subject to the MIT License as seen in the  Crest folder (LICENSE)
// It has been modified by the FPC Swimmer Pack to fix a bug occurring on the underwater material.
...
namespace FPCSwimmer
{
    ...
    /// </summary>
    [ExecuteAlways]
    public partial class UnderWaterCustomEffect : MonoBehaviour
    {
        ...
        private void Awake()
        {
            // FIX from the FPCSwimmer plugin:
            // Reloads automatically the material, to avoid bug with CopyPropertiesFromMaterial.
            // Without this fix, the material gets corrupted when copying params from ocean material.
            _rend = GetComponent<Renderer>();
            Material newFreshMaterial = new Material(_rend.sharedMaterial);
            _rend.sharedMaterial = newFreshMaterial;
        }
...
#if UNITY_EDITOR
    public partial class UnderWaterCustomEffect : IValidated
    {
    ...
    [CustomEditor(typeof(UnderWaterCustomEffect)), CanEditMultipleObjects]
    class UnderWaterCustomEffectEditor : ValidatedEditor { }
#endif
}
